...
export const SALLES_DATA = {
  'Salle Conseil - 100 Personnes': {
    nom: 'Salle Conseil',
    capacite: 100,
    photo: '/images/Salle_Conseil.jpg',
  ...
  'Salle Mariages - 30 Personnes': {
    nom: 'Salle Mariages',
    capacite: 30,
    photo: '/images/Salle_Mariages.jpg',
