...
function SingleRoomGrid({ selectedRoom, onBack, onSuccess }) {
  ...
  const getFormTitle = () => { const count = mergedForDisplay.length; if (count > 1) return `Réservation de ${count} créneaux`; return "Réservation d'un créneau"; };
  ...
  return (
    <>
      ...
      <div className="single-room-container">
        ...
        {/* POPUP DE SURVOL AVEC AGENCEMENT */}
        {hoveredReservation && (
